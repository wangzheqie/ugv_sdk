 ...
 * @Author    : Wang Zhe
 * @Date      : 2021-04-19  16:52:3
 * @FileName  : ranger_types.hpp
 * @Mail      : wangzheqie@qq.com
 * Copyright  : AgileX Robotics
 **/

#ifndef RANGER_TYPES_HPP
#define RANGER_TYPES_HPP
...
struct RangerMotionCmd {
  ...
  RangerMotionCmd(int8_t linear = 0, int8_t angular = 0,
