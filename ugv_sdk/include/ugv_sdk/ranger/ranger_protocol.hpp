 ...
 * @Author    : Wang Zhe
 * @Date      : 2021-04-19  16:51:56
 * @FileName  : ranger_protocol.hpp
 * @Mail      : wangzheqie@qq.com
 * Copyright  : AgileX Robotics
 **/


#ifndef RANGER_PROTOCOL_HPP
#define RANGER_PROTOCOL_HPP
...
#define RANGER_CMD_BUF_LEN               32
#define RANGER_STATUS_BUF_LEN            32
#define RANGER_FRAME_SIZE                13

#define RANGER_MOTOR1_ID                 ((uint8_t)0x00)
#define RANGER_MOTOR2_ID                 ((uint8_t)0x01)
#define RANGER_MOTOR3_ID                 ((uint8_t)0x02)
#define RANGER_MOTOR4_ID                 ((uint8_t)0x03)
...
typedef enum
{
    RangerMsgNone = 0x00,
    // status messages
    RangerMotionStatusMsg = 0x01,
    RangerLightStatusMsg = 0x02,
    RangerSystemStatusMsg = 0x03,
    RangerMotorDriverStatusMsg = 0x04,
    // control messages
    RangerMotionControlMsg = 0x21,
    RangerLightControlMsg = 0x22
} RangerMsgType;
